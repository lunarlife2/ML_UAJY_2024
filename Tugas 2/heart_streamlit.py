...
model_path = r'D:\atma\Semester 5\ML\Heart - Modul 2'
...
st.title("Prediksi Potensi Penyakit Jantungq")
...
RestingECG = st.selectbox("Resting ECD",["LVH","Normal","ST"])
...
input_data = [[input_sex_F, input_sex_M, input_cpain_ASY, input_cpain_ATA,
               input_cpain_NAP, input_cpain_TA, input_restecg_LVH, input_restecg_NORMAL,
               input_restecg_ST, input_anginaN, input_anginaY, input_STslope_down,
               input_STslope_flat, input_STslope_up, Age, RestingBP, Cholesterol,
               input_fastbs, MaxHR, Old_peak]]
