...
model_directory = r'D:\atma\Semester 5\ML\DiabetesApp - Modul 1'
...
if os.path.exists(model_path):
    try:
        ...
        st.write("Aplikasi ini digunakan unutk membantu memprediksi penyakit diabetes pada seseorang")
    ...
    print("File 'rf_diabetes_model.pkl' tidak ditemukan di directory")
